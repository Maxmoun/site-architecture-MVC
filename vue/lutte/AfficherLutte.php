...
<body>  
    <h1>To-Do List</h1>  
    <a href="CreerLutte.php">Créer apropos</a>  
    <table>  
        <thead>  
            <tr>  
                <th>Titre</th>  
        ...
        <tbody>  
            <?php while ($row = $luttes->fetch(PDO::FETCH_ASSOC)): ?>  
                <tr>  
                    ...
                    <td class="actions">  
                        <a href="EditerLutte.php?id=<?php echo $row['id']; ?>">Modifier</a>  
                        <a href="SupprimerLutte.php?id=<?php echo $row['id']; ?>">Supprimer</a>  
                    </td>  
                </tr>  
            <?php endwhile; ?>  
        </tbody>  
