        ...
        if ($fileError === UPLOAD_ERR_OK) {  
            ...
            if (in_array($fileExtension, $allowedfileExtensions)) {  
                ...
                if (move_uploaded_file($fileTmpPath, $photo)) {  
                    ...
                    $aproposControlleur->create($titre, $description, $photo);  
    ...
    <section>
        <div class="container">
            <div style="text-align:center">
                <h2>CREER APROPOS </h2>
                <p>vous pouvez creer la section apropos</p>
            </div>
            <div class="row">
                <div class="column">
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <textarea id="description" name="description" style="height:170px" required></textarea>
