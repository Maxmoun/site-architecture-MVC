...
<body>  
    <h1>To-Do List</h1>  
    <a href="CreerApropos.php">Créer apropos</a>  
    <table>  
        <thead>  
            <tr>  
                <th>Titre</th>  
        ...
        <tbody>  
            <?php while ($row = $aproposs->fetch(PDO::FETCH_ASSOC)): ?>  
                <tr>  
                    ...
                    <td class="actions">  
                        <a href="EditerApropos.php?id=<?php echo $row['id']; ?>">Modifier</a>  
                        <a href="SupprimerApropos.php?id=<?php echo $row['id']; ?>">Supprimer</a>  
                    </td>  
                </tr>  
            <?php endwhile; ?>  
        </tbody>  
