...
<body>  
    <h1>To-Do List</h1>  
    <a href="CreerMonnaie.php">Créer apropos</a>  
    <table>  
        <thead>  
            <tr>  
                <th>Titre</th>  
        ...
        <tbody>  
            <?php while ($row = $monnaies->fetch(PDO::FETCH_ASSOC)): ?>  
                <tr>  
                    ...
                    <td class="actions">  
                        <a href="EditerMonnaie.php?id=<?php echo $row['id']; ?>">Modifier</a>  
                        <a href="SupprimerMonnaie.php?id=<?php echo $row['id']; ?>">Supprimer</a>  
                    </td>  
                </tr>  
            <?php endwhile; ?>  
        </tbody>  
