...
class Monnaie {  
    ...
    public function read() {  
        $query = "SELECT * FROM monnaies ORDER BY id DESC"; // Utiliser une colonne existante    
    ...
    public function update() {  
        $query = "UPDATE " . $this->table . " SET titre=:titre, description=:description, photo=:photo, lien=:lien WHERE id=:id";  
        $stmt = $this->conn->prepare($query);  
